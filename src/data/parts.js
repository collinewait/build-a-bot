const images = require.context('./images', true, /\.png$/);// using webpack's require.context here to make webpack aware of the image urls so that we can just use them throughout the json data as relative yrls
